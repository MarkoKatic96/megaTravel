package megatravel.agentlocal.token;
...
import megatravel.agentlocal.security.AgentDetails;
...
public class JwtTokenUtils {
	...
	public String createToken(String email) {
		...
		tipoviKorisnika.add(new SimpleGrantedAuthority(StaticData.tipAgenta));
