package bezbednostEtapa2.token;
...
import bezbednostEtapa2.security.KorisnikDetails;
...
public class JwtTokenUtils {
	...
	@Autowired
	private KorisnikDetails korisnikDetails;
	...
	public String createToken(String email) {
		...
		tipoviKorisnika.add(new SimpleGrantedAuthority(StaticData.tipKorisnika));
	...
	public Authentication getAuthentication(String token) {
		UserDetails userDetails = korisnikDetails.loadUserByUsername(getUsername(token));
