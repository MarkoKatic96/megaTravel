...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/*", "agent/login", "/agent/login", "/agent-global-service/agent/signup", "/agent-global-service/admin/*", "/agent-global-service/admin/confirmrequest/*", "/agent-global-service/admin/refuserequest/*").permitAll()
