...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/*", "agent/login", "/agent/login", "/agent/signup", "/smestaj-service/smestaj-korisnik/*","/smestaj-service/smestaj-korisnik/all","/smestaj-service/smestaj-korisnik/id/*", "/smestaj-service/smestaj-korisnik/dodaj-uslugu/*/*", "/smestaj-service/smestaj-korisnik/rastojanje/*").permitAll()
